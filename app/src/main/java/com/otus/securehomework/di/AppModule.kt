...
object AppModule {
    ...
    fun provideUserPreferences(
        ...
        encryptionAes: AesEncryptionManager
    ): UserPreferences {
        return UserPreferences(context, encryptionAes)
    }

    @Provides
    fun providesEncryptionAes(aesSecretKeyProvider: AesKeyProvider): AesEncryptionManager {
        return AesEncryptionManager(aesSecretKeyProvider)
    }
}
